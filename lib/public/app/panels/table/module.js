...
function (angular, app, _, kbn, moment) {
  ...
  module.controller('table', function($rootScope, $scope, $modal, $q, $compile, $timeout,
    ...
    $scope.fieldTitle = function(input) {
      var output = '';
      output = output + input;
      switch (input) {
        case 'timestamp':
        ...
        case 'triggered.dest':
          ...
          break;
        case 'triggered.source':
          output = 'Source IP';
          break;
        case 'topology.topology':
          output = 'Topology';
          break;
        case 'topology.topology_instance':
          output = 'Topology Instance';
          break;
        case 'triggered.priority':
          output = 'Priority';
          break;
        case 'triggered.title':
          output = 'Title';
          break;
        case 'triggered.type':
          output = 'Type';
        ...
        case 'environment.customer':
          output = 'Customer';
          break;
        case 'environment.datacenter':
          output = 'Datacenter';
          break;
        case 'environment.instance':
          output = 'Environment Instance';
          break;
        case 'triggered.content':
          output = 'Content';
          break;
      }
